...
public partial class ESkeletonLoader : ContentView
{
    public static readonly BindableProperty SpeedProperty =
        BindableProperty.Create(nameof(Speed), typeof(double), typeof(ESkeletonLoader), 1d);
    
    public static readonly BindableProperty DelaySecondProperty =
        BindableProperty.Create(nameof(DelaySecond), typeof(double), typeof(ESkeletonLoader), 1d);
